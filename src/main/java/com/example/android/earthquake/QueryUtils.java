...
public final class QueryUtils {
    ...
    public static ArrayList<Earthquake> extractEarthquakes() {
        ...
        try {
            ...
            //Make a for loop through each feature in the array
            for (int i = 0; i < featuresArray.length(); i++) {
                ...
                //Extract "time" as a long data type instead of a String
                long time = properties.getLong("time");

                //Create Earthquake object from magnitude, location, and time
